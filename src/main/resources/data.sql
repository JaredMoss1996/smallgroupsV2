...
('Neighborhood Outreach', 'Service projects around the neighborhood.', 'Saturdays 9am', 'Community Center', '456 Oak Ave', 'bob@example.com', 'BOTH', 'ALL', 'MONTHLY'),
...
('Seniors Breakfast', 'Breakfast and discussion for seniors.', 'Fridays 8am', 'Senior Center', '202 Elm St', 'eve@example.com', 'BOTH', 'SEVENTIES_AND_UP', 'VARIES');
